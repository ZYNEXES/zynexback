"""
Django settings for znxbck project.
...
WSGI_APPLICATION = 'znxbck.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static')  # Add this if you have a "static" folder
]
